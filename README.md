...
🔥**Highlight!!**  
(1) We review the research work on symmetric structure multi-modal fusion neural networks for 3D semantic segmentation, such as data-data, feature-feature, and result-result in the last five years
(2) We review the research work on asymmetric structure multi-modal fusion neural networks for 3D semantic segmentation, such as data-feature, data-result, and feature-result in the last five years
(3)  We summarize the development of multi-modal fusion neural networks for 3D semantic segmentation and propose the future development prospects
